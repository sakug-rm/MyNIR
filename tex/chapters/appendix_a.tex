\chapter{Приложение А. Дополнительные synthetic-эксперименты и проверки устойчивости}
\label{app:prilozhenie-a-dopolnitelnye-synthetic-eksperimenty-i-proverki-ustoichivosti}

В основное тело диплома включены только те synthetic-результаты, которые непосредственно поддерживают центральный тезис работы. Остальные материалы вынесены в приложение.
...
\item
  Резервные parameter sweeps и дополнительные сценарии по параметрам \(q\) и \(\gamma\) смешанной модели.
\item
